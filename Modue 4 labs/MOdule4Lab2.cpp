...
// Program that uses a user created function to take the 2 arrays as parameters and output on screen

#include <iostream>
#include <iomanip>	//include iomanip library for formatting
using namespace std;

// Prototype custom function that will take two arrays and print in a certain format
int carData(string vehicleName[],double mpGallon[]);
